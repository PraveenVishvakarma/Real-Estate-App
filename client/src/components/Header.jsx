  ...
  return (
    <header className='bg-slate-200 shadow-md'>
        ...
        <form onSubmit={handleSubmit} className='bg-slate-100 p-3 rounded-lg flex items-center'>
                ...
                type='text' placeholder='Search...' className='bg-transparent focus:outline-none w-24 sm:w-64'></input>
                <button>
        ...
        <ul className='flex gap-4'>
            ...
            <Link to="/profile">
              {currentUser ? (<img className='rounded-full h-7 w-7' src={currentUser.avatar} />):(<li className='text-slate-600 hover:underline'>Sign in</li>)}
            </Link> 
        </ul>
        </div>
    </header>
